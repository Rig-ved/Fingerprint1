var FinoveraFingerprint = function(e) {
    ...
    class v {
        ...
        getBlueToothAvailaibility() {
            return h(this, null, (function*() {
                try {
                    if ("undefined" == typeof navigator || !navigator) return console.warn("Navigator is not available"), !1;
                    if (!("bluetooth" in navigator) || void 0 === navigator.bluetooth) return console.warn("Web Bluetooth API is not supported in this document."), !1;
                    if (window.self !== window.top) return console.warn("Permissions for Web Bluetooth API is not supported inside an iframe."), !1;
                    {
                        let e = null;
                        try {
                            if ("function" != typeof navigator.bluetooth.getAvailability) return console.warn("getAvailability method is not available"), !1;
                            e = yield navigator.bluetooth.getAvailability();
                            try {
                            ...
                            return console.warn("Failed to get bluetooth availability:", e), !1
                        }
                    }
                } catch (e) {
                    return console.error("Unexpected error in bluetooth availability check:", e), !1
                }
            }))
        }
        getOS(e) {
                ...
                return new Promise((e => {
                    ...
                    t ? t.getHighEntropyValues(["brands", "mobile", "platform", "architecture", "bitness", "fullVersionList", "model", "platformVersion", "wow64"]).then((t => {
                        const i = {
                            ...
                            "Sec-CH-UA-Arch": P(t.architecture),
                            "Sec-CH-UA-Mobile": "?" + (t.mobile ? "1" : "0"),
                            "Sec-CH-UA-Model": P(t.model),
                            "Sec-CH-UA-Platform": P(t.platform),
                            "Sec-CH-UA-Platform-Version": P(t.platformVersion),
                            "Sec-CH-UA-Full-Version-List": M(t.fullVersionList),
                            "Sec-CH-UA-Bitness": P(t.bitness),
