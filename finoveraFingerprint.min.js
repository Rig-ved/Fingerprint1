        ...
        getBlueToothAvailaibility() {
            return h(this, null, (function*() {
                try {
                    ...
                    let e = null;
                    try {
                        return "function" != typeof navigator.bluetooth.getAvailability ? (console.warn("getAvailability method is not available"), !1) : (e = yield navigator.bluetooth.getAvailability(), Boolean(e))
                    } catch (e) {
